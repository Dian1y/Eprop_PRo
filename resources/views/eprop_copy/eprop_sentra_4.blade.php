...
@section('content')
<form class="form-horizontal form-group-sm" method="POST" action="{{ route('CPostFourthPage') }}">
  <div class="row">
    ...
    <div class="col-xs-12">
      <div class="box">
         ...
         @endif
         <a href="{{ route('copy.SentraPrevPage3') }}" class="btn bg-maroon btn-sm margin pull-right"><< Prev Page </a>
